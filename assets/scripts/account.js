function goBack() {
    document.querySelector('.main-container').style.transform = 'translateX(-20px)';
...
function changeEmail() {
    ...
    alert('Email change request submitted! Please check your inbox for verification.');
...
function confirmDeleteAccount() {
    ...
    deleteBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Processing...';
...
function deleteAccount() {
    const confirmation = confirm('Are you absolutely sure you want to delete your account?\n\nThis action cannot be undone and all your data will be permanently deleted.');
...
document.getElementById('personalForm').addEventListener('submit', function(e) {
    ...
    setTimeout(() => {
        saveBtn.innerHTML = '<i class="fas fa-check me-2" style="color: #ffffff;"></i>Saved!';
